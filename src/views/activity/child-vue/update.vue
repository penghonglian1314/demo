  ...
  <el-container class="dialog_main">
    <el-main>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="是否上架:" prop="IsOnShelves">
              <el-switch
                v-model="updateForm.IsOnShelves"
                active-color="#909399"
        ...
        <el-row>
          <el-col :span="15">
            <el-form-item label="活动类型：" prop="ActivityType">
              <!-- <el-input v-model="addForm.ActivityType" placeholder="请输入活动类型 如：热门活动，新品上市等" show-word-limit clearable :style="{width: '200%'}" /> -->
              <el-select v-model="updateForm.ActivityType" clearable placeholder="请选活动类型" :style="{width: '100%'}">
                <el-option
          ...
          <el-col :span="15">
            <el-col :span="12">
              <el-form-item label="商品名称:">
                <el-input v-model="updateForm.ShowTitle" auto-complete="off" disabled />
              </el-form-item>
            </el-col>
            <!-- <el-col :span="12">
        ...
        <el-row>
          <el-col :span="15">
            <el-form-item label="优先级：" prop="Priority">
              <!-- <el-input v-model="updateForm.Priority" placeholder="请输入优先级，数字越小优先级越高，默认50" show-word-limit clearable :style="{width: '200%'}" /> -->
              <el-input-number v-model="updateForm.Priority" :min="1" :max="50" controls-position="right" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
      <div class="dialog-footer">
        ...
        <el-button type="primary" @click="updateMallGoodsActivity()">确 定</el-button>
      </div>
...
export default {
  ...
  methods: {
    submitReferees(row) {
      ...
      this.updateForm.ShopID = row.ShopID
    ...
    updateMallGoodsActivity() {
      ...
      updateMallGoodsActivity(this.updateForm).then((res) => {
        if (res.data.success) {
          this.$message({
            type: 'success',
            message: '修改成功'
