...
export default {
  ...
  methods: {
    ...
    handlePreview(file) {
      console.log(file.url, '7777777777')
    ...
    insertInfo(item) {
      console.log(item)
      console.log('insert')
      var code = item.ItemCode === undefined ? '31_1' : item.ItemCode
