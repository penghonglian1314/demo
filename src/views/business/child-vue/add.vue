        ...
        <el-row>
          ...
          <el-col :span="12"> -->
            <el-form-item label="公司法人姓名:" prop="Corporate">
              <el-input v-model="addForm.Corporate" auto-complete="off" placeholder="请输入公司法人姓名" />
            </el-form-item>
            <!-- </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12"> -->
            <el-form-item label="公司法人电话:" prop="CorporateTelNo">
              <el-input v-model="addForm.CorporateTelNo" auto-complete="off" placeholder="请输入公司法人电话" />
            </el-form-item>
            <!-- </el-col>
          <el-col :span="12"> -->
            <el-form-item label="管理员:" prop="ManagerMemberID">
              <el-input v-model="addForm.ManagerMemberID" auto-complete="off" placeholder="请输入管理员" />
            </el-form-item>
            <!--  </el-col>
          <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    //   this.addForm.CorporateCardFileID = this.getImgUrl(res)
