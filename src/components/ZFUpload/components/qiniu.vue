...
// import { getFileServerToken } from '@/api/qiniu'
...
export default {
  ...
  methods: {
    ...
    async beforeUpload(file) {
      ...
      // this.postDatas.key = (new GUID()).newGUID()
